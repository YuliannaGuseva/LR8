...
namespace ClimateEquipment
{
    public partial class FormManager1 : Form
    {
        ...
        public FormManager1(string name)
        {
            InitializeComponent();
            labelName.Text = name;
            LoadRequests();
        ...
        private void labelViewDetails_Click(object sender, EventArgs e)
        {
            FormManager2 customerForm = new FormManager2(labelName.Text);
            customerForm.Show();
            this.Hide();
        }
        ...
        private void FormManager1_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
